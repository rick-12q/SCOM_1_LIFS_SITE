...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{2-imagens/print_celular}
		\caption{}
		\label{fig:printcelular1}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{2-imagens/print_celular2}
		\caption{}
		\label{fig:printcelular2}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.30\linewidth}
		\centering
		\includegraphics[width=\linewidth]{2-imagens/print_celular3}
		\caption{}
		\label{fig:printcelular3}
	\end{subfigure}
	
	\caption{Capturas de tela da interface vista em um dispositivo \textit{mobile}, no caso, um celular.\\ \centering Fonte: O autor, 2026.}
	\label{fig:prints-celular}
\end{figure}
